    ...
    <div className="sf-page">
      ...
      {monthBills.length === 0 && (
        <div className="card" style={{ textAlign: "center", padding: 36 }}>
          ...
          <p className="muted small" style={{ marginBottom: 14 }}>Connect a utility provider and BillSplice will pull in the bill amount and due date for you.</p>
  ...
  return (
    <Modal title="Connect a utility account" onClose={onClose}>
      {step === "form" && (
        <div>
          <p className="small muted" style={{ marginBottom: 14 }}>
            BillSplice logs into your utility account, imports the current bill amount and due date, and automatically detects new bills each month.
          </p>
          ...
          <p className="small muted" style={{ marginBottom: 10 }}>
            Your credentials are used only to fetch your bill — they are never stored on BillSplice's servers.
          </p>
      ...
      {step === "success" && importedBill && (
        <div style={{ textAlign: "center", padding: "20px 0" }}>
          ...
          <p className="small muted" style={{ marginBottom: 14 }}>
            This bill is now visible to your whole house. BillSplice will automatically detect next month's bill too.
          </p>
        ...
        {mode === "welcome" && (
          <div>
            <h1 className="sf-display" style={{ fontSize: 30, lineHeight: 1.15, marginBottom: 10 }}>
              Roommate bills, spliced.<br />On time, every time.
            </h1>
            <p style={{ color: "#9DC4BE", marginBottom: 24 }}>
              Connect your utilities, pool everyone's share in a house wallet, and BillSplice pays the bills automatically — with a roommate score that keeps everyone honest.
            </p>
...
function Logo({ dark }) {
  return (
    <span className="row" style={{ gap: 9 }}>
      ...
      <b className="sf-display" style={{ fontSize: 19, color: dark ? "var(--ink)" : "#fff" }}>BillSplice</b>
    </span>
  );
}
